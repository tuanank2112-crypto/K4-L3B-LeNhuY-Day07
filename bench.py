...
BENCHMARK_QUERIES = [
    {
        "id": 1,
        "query": "Thời gian áp dụng 1 đổi 1 miễn phí cho điện thoại bị lỗi nhà sản xuất tại CellphoneS là bao lâu?",
        "filter": None,
        "expected_doc": "cellphones-warranty-policy",
        "gold_answer": "1 đổi 1 trong vòng 30 ngày đầu tiên kể từ thời điểm nhận hàng (đối với đơn online không quá 5 ngày so với ngày xuất hóa đơn).",
    },
    {
        "id": 2,
        "query": "Khách hàng mua phụ kiện dưới 1 triệu tại CellphoneS được bảo hành đổi mới như thế nào?",
        "filter": None,
        "expected_doc": "cellphones-warranty-policy",
        "gold_answer": "Phụ kiện có giá dưới 1.000.000 VNĐ được đổi mới miễn phí trong vòng 01 năm (12 tháng) đối với hàng mới, hoặc đổi trong 01 tháng đối với hàng cũ.",
    },
    {
        "id": 3,
        "query": "Chính sách đổi trả sản phẩm lỗi do nhà sản xuất tại FPT Shop quy định thời hạn đổi mới bao nhiêu ngày?",
        "filter": None,
        "expected_doc": "fptshop-return-policy",
        "gold_answer": "1 đổi 1 trong 30 ngày đầu đối với điện thoại, máy tính bảng, laptop nếu có lỗi phần cứng từ nhà sản xuất.",
    },
    {
        "id": 4,
        "query": "Điều kiện và phí trả hàng khi máy không lỗi hoặc đổi ý tại CellphoneS trong 30 ngày đầu là bao nhiêu?",
        "filter": None,
        "expected_doc": "cellphones-warranty-policy",
        "gold_answer": "Thu phí 20% đối với máy mới (15% đối với máy cũ) tính trên giá niêm yết hiện tại hoặc giá mua trên hóa đơn (lấy giá trị thấp hơn).",
    },
    {
        "id": 5,
        "query": "Trách nhiệm và quy định thời hạn tiếp nhận xử lý bảo hành khi nhận sản phẩm từ người mua là gì?",
        "filter": {"audience": "seller"},
        "expected_doc": "seller-warranty-policy",
        "gold_answer": "Người bán phải tiếp nhận và xử lý bảo hành trong vòng 48 giờ làm việc kể từ khi nhận sản phẩm, thời gian hoàn tất tối đa 14 ngày làm việc.",
    },
]
